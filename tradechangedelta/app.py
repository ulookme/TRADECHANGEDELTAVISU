...
st.markdown(
    "*Il faut savoir que l'intélligence artificiel ici en cour de trade s'adapte au condition du marcher* "
    "*il peut autant effectuer des vente et achat a haut frequence et sur le moyen terme* "
    "*,il est toujours en cours de teste et d'amélioration cependant il n'a jamais perdu au change :°* "
)
...
st.write("Prix actuelle des cours du MARCHE BAT",round(float(prix),3))
